...
<body class="d-flex flex-row">
  ...
  <section class="w-50 d-flex-center" id="picture_Section">
    <picture>
      <img src="images/Two-factor authentication-amico.png" alt="" class="w-100">
    </picture>
  </section>

  <!-- Verify Email Address Section -->
  <section class="w-50 border border-1 d-flex flex-column gap-4" id="email_Section">
    ...
    <div class="d-flex-center w-100">
      <button class="btn btn-success w-50 cstm-lttr-spcng fw-bold fs-5" id="sendVerificationBtn">Send Verification Code</button>
    </div>
    ...
    <div class="w-100 d-flex-center text-secondary small pt-3">
      <p class="w-50 text-center">
        ...
        Please complete this step before proceeding with registration.
      </p>
    </div>
